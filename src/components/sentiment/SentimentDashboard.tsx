        ...
        <div className="bg-slate-900 rounded-lg shadow-sm border border-slate-800 p-3 mt-4 mb-4">
            ...
            <div className="flex justify-between items-center mb-3">
                ...
                <button
                    onClick={handleCrawl}
                    disabled={crawling}
                    className={`flex items-center gap-1 px-2 py-1 rounded text-xs font-medium transition-colors ${crawling
            ...
            <div className="flex flex-col lg:flex-row gap-3 h-auto lg:h-[450px]">
                ...
                <div className="lg:w-2/3 flex flex-col gap-3 min-h-0">
                    ...
                    {/* Trend Chart (Smaller) */}
                    <div className="flex-1 min-h-[250px] lg:min-h-0 bg-slate-800/50 rounded-lg p-1 border border-slate-700/50 overflow-hidden relative flex flex-col">
