...
cat "$ROOT_DIR/data/user_data.db" | ssh "$NAS_HOST" "cat > '$NAS_DATA_ROOT/user_data.db'"
cat "$ROOT_DIR/data/market_data.db" | ssh "$NAS_HOST" "cat > '$NAS_DATA_ROOT/market_data.db'"
