...
def write_markdown(model_df: pd.DataFrame, overlay_df: pd.DataFrame) -> None:
    ...
    lines.extend(
        [
            ...
            "## 5. 对应产物",
            "",
            "- [probe_signal_strengthening_model_compare.csv](/Users/dong/ZhangData/market-live-terminal/docs/strategy-rework/experiments/20260603-probe-lift-research/probe_signal_strengthening_model_compare.csv)",
            "- [probe_signal_strengthening_bucket_compare.csv](/Users/dong/ZhangData/market-live-terminal/docs/strategy-rework/experiments/20260603-probe-lift-research/probe_signal_strengthening_bucket_compare.csv)",
            "- [probe_signal_strengthening_overlay_compare.csv](/Users/dong/ZhangData/market-live-terminal/docs/strategy-rework/experiments/20260603-probe-lift-research/probe_signal_strengthening_overlay_compare.csv)",
        ]
    )
