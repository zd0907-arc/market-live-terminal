...
CREATE TABLE IF NOT EXISTS atomic_trade_5m (
    ...
    l1_main_buy_count INTEGER NULL,
    l1_main_sell_count INTEGER NULL,
    l1_super_buy_count INTEGER NULL,
    l1_super_sell_count INTEGER NULL,
    l2_main_buy_count INTEGER NULL,
    l2_main_sell_count INTEGER NULL,
    l2_super_buy_count INTEGER NULL,
    l2_super_sell_count INTEGER NULL,
    ...
    max_trade_amount REAL NULL,
    avg_trade_amount REAL NULL,
    max_parent_order_amount REAL NULL,
    top5_parent_concentration_ratio REAL NULL,
...
CREATE TABLE IF NOT EXISTS atomic_order_daily (
    ...
    order_event_count INTEGER NULL,
    oib_top3_concentration_ratio REAL NULL,
    moderate_positive_oib_bar_count INTEGER NULL,
    moderate_positive_oib_bar_ratio REAL NULL,
    positive_oib_streak_max INTEGER NULL,
