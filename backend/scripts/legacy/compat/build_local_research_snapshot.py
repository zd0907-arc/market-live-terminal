...
REPO_ROOT = next(
    (parent for parent in Path(__file__).resolve().parents if (parent / "backend").is_dir() and (parent / "docs").is_dir()),
...
DEFAULT_SELECTION_DB_CANDIDATES = (DEFAULT_SELECTION_DB,)
