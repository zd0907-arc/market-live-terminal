...
示例：
python3 backend/scripts/maintenance/audit/audit_l2_order_event_codes.py /tmp/lt_l2/20260311 --symbols sh603629 --json
python3 backend/scripts/maintenance/audit/audit_l2_order_event_codes.py /tmp/day_root --limit 50
"""
