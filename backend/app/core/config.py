...
DEFAULT_ATOMIC_LEGACY_MAINBOARD_DB_FILE = os.path.join(ATOMIC_FACTS_DIR, "market_atomic_mainboard_full_reverse.db")
...
def candidate_atomic_db_paths() -> List[str]:
    ...
    # 当前默认正式底座是 compact；legacy full_reverse 仅保留为兼容回退候选。
    compact_candidates = []
    ...
    candidates = [
        *compact_candidates,
        ...
        ATOMIC_DB_PATH,
        DEFAULT_ATOMIC_LEGACY_MAINBOARD_DB_FILE,
