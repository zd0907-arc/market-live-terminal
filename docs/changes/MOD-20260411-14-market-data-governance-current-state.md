...
### Phase 1：先把利通样板按 P1-A 跑透
1. 先以利通样板票验证 P1-A 新字段是否稳定落值
2. 看这些字段能否更好解释‘先藏后打’窗口
3. 利通通过后，再决定横向抽哪些股票做小样本验证
4. 在此基础上，先补 **涨跌停状态层** 设计与样板验证
5. 继续维持‘旧库只读，新库承接’的迁移边界，不做旧库原地改造

### Phase 2：补集合竞价层（摘要 + phase）
1. 先保留当前竞价摘要层
2. 再补竞价 phase 过程层设计与 raw 审核
3. 小样本跑通 L1 / L2 竞价摘要与 phase
4. 再决定是否扩全样本
