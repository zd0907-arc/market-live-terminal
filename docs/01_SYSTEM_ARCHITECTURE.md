...
>
> **当前真相提醒（2026-04-21）**：本文件中大量早期段落仍保留历史架构演化过程；阅读时请先以 `docs/changes/MOD-20260421-01-project-current-state-and-doc-governance-normalization.md` 作为当前入口，再回看本文件的历史边界说明。
