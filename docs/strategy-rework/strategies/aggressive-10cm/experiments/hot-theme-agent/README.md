...
| 2026-03-02~2026-05-11 | leader_attack | -6.49 | -15.89 | 26 | 34.62 | -0.83 |
| 2026-03-02~2026-05-11 | theme_resonance | 12.01 | -8.70 | 19 | 42.11 | 2.11 |

## 最优变体

- 以全区间 `net_return_pct` 优先、`max_drawdown_pct` 次优筛选，当前最优：`theme_resonance`。
- 全区间表现：收益 12.01% ，最大回撤 -8.70% ，交易 19 笔，胜率 42.11%。
