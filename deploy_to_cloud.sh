...
# ==============================================================================
# 兼容说明（2026-06-07）：这是旧腾讯云 / flat-data 发布链，
# 当前正式线上默认入口已经转到 NAS live/ + research/current，不要把它当主发布口径。
# 使用说明:
...
echo "========================================================"
echo " 🚀 准备向旧 Cloud 兼容环境 ($SERVER_USER@$SERVER_IP) 发布最新版 🚀"
echo "========================================================"
echo ""
...
# 2. 交互式动作确认 (必须由人工审核)
echo "📋 即将在旧 Cloud 兼容环境上自动执行以下指令流:"
...
read -p "🚨 请审核部署指令，确认是否立即下发到旧 Cloud 兼容环境？ [y/N]: " confirm
